...
form.markdown("<spam style='font-size:50px; font-weight:bold;'>Gender Detection</spam><spam style='font-size:20px; font-weight:bold; color: gray;'> for Burmese Name</spam>", unsafe_allow_html=True)
